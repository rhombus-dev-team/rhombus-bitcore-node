...
**Note**: To install services [insight-api](https://github.com/rhombus/rhombus-insight-api) and [insight-ui](https://github.com/rhombus/rhombus-insight-ui) you'll need to clone the repositories locally.
